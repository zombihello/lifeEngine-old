...
namespace le
{
	...
	class DLL_API LightManager2D
	{
	public:
		/////////////////
		/// КОНСТРУКТОР
		////////////////
		LightManager2D( System& System );
		LightManager2D( System& System, Vector2f SizeMap );
		...
		/// ПОЛУЧИТЬ СВЕТ
		//////////////////
		Light2D* GetLight( int id );
		Light2D* GetLight( string NameLight );
