...
namespace le
{
	...
	public:
		...
		/// КОНСТРУКТОР
		////////////////
		Body2D( Physic2D& Physic, Vector2f Position, string NameBody, TYPE_BODY TypeBody = STATIC );
		Body2D( Physic2D& Physic, Vector2f Position, float Angle, string NameBody, TYPE_BODY TypeBody = STATIC );
		...
		///////////////////////////////////////
		bool IsBodyColision( Body2D* Body );
	...
	private:
		...
		string                          sNameBody;
		b2Filter*						Filter;
		vector<CircleShape2D*>            vCircle;
		vector<PolygonShape2D*>           vShape;
	};
