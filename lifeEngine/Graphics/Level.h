...
namespace le
{
	...
	public:
		...
		/// \return BaseEntity*. Если не нашли энтити,то вернет NULL
		//////////////////////////////////////////////////////////////////////
		BaseEntity* GetEntity( const string& NameEntity );
		...
		//////////////////////////////////////////////////////////////////////
		map<string, map<string, string> >&	GetNoParseEntity();
	...
	private:
		...
		//////////////////////////////////////////////////////////////////////
		/// \brief Считать энтити-объект с карты
		///
		/// \param[in] EntityData Данные энтити-объекта
		//////////////////////////////////////////////////////////////////////
		void ParseEntity( const string& EntityData );
		...
		map<string, map<string, string> >	NoParseEntity;		///< Энтити-объекты которые не созданы
	};
