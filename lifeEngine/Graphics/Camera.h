...
namespace le
{
	...
	public:
		...
		//////////////////////////////////////////////////////////////////////
		/// \brief Получить растояние камеры до объекта
		///
		/// \param[in] PositionObject Позиция объекта в мире
		/// \return float
		//////////////////////////////////////////////////////////////////////
		inline float GetDistanceToObject( const glm::vec3& PositionObject );
